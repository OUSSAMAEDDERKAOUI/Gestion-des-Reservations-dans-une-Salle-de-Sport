...
<body>
    ...
    <div class="w-[50%] mx-auto text-center">
        <h1 class="font-bold text-5xl text-[#0ea5e9] my-5">Tableau de Bord Administrateur</h1>
        <p class="font-bold text-2xl my-5">Gérez les réservations et les utilisateurs</p>
    </div>
    <table class="min-w-full divide-y divide-gray-200 my-12 ">
        <thead>
            <tr>
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wide ">Nom</th>
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Prenom</th>
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Email</th>
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Telephone</th>
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nom D'activite</th>
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Date de Reservation</th>
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Statut De Reservation</th>
            </tr>
        </thead>
    ...
    ";
            ...
            while ($rows = mysqli_fetch_assoc($forma_query)) {
                ...
                echo '<td class="px-6 py-4 whitespace-nowrap text-center">' . $rows['Nom_Activite'] . '</td>';
                echo '<td class="px-6 py-4 whitespace-nowrap text-center">' . $rows['Date_Reservation'] . '</td>';
                echo   '<td class="px-6 py-4 whitespace-nowrap text-center">';
                echo '<span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">' . $rows['Statut'] . '</span>';
                echo '</td>';
